...
class FlanTransitionVisiable extends StatefulWidget {
  const FlanTransitionVisiable({
    required this.transitionBuilder, required this.child, Key? key,
    this.duration,
  ...
  @override
  FlanTransitionVisiableState createState() => FlanTransitionVisiableState();
}

class FlanTransitionVisiableState extends State<FlanTransitionVisiable>
