...
class FlanButton extends FlanRouteStatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _FlanButtonSize btnSize = _getBtnSize(themeData);
    final _FlanButtonTheme themeType = _getThemeType(themeData);
    ...
    final TextStyle textStyle = TextStyle(
      ...
      color: textColor ?? themeType.color,
    );
