...
class FlanToastTheme extends InheritedTheme {
  ...
  static Widget merge({
    required FlanToastThemeData data, required Widget child, Key? key,
  }) {
    return Builder(
...
class FlanToastThemeData with Diagnosticable {
  factory FlanToastThemeData({
    ...
    final double fontSizeNew = fontSize ?? FlanThemeVars.fontSizeMd.rpx;
    return FlanToastThemeData.raw(
      ...
      lineHeight: lineHeight ?? (FlanThemeVars.lineHeightMd.rpx / fontSizeNew),
